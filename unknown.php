...
<html lang="en">
  <head>
    ...
    <title>muckrake | unknown traps</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li><a href="index.php">Traps</a></li>
            <li class="active"><a href="#">Unknown Traps</a></li>
          </ul>
...
$where = array();
    ...
    if (!empty($_GET['f'])) {
        ...
        $traps = getUnknownTraps($where,"OR",$lower_limit,$pag);
        $total_count = getUnknownTrapCount($where,"OR");
} else {
		$traps = getUnknownTraps($where,"AND",$lower_limit,$pag);
        $total_count = getUnknownTrapCount($where,"AND");
}

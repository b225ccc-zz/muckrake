...
<div class="panel panel-info">
    <div class="panel-body">
      <p>
        ...
        <dl class="dl-horizontal">
          <dt>Event name</dt>
          <dd><tt><?php echo $details['eventname']; ?></tt></dd>
        </dl>
        <dl class="dl-horizontal">
          <dt>Event ID</dt>
          <dd><tt><?php echo $details['eventid']; ?></tt></dd>
        </dl>
        <dl class="dl-horizontal">
          <dt>OID</dt>
        ...
        <dl class="dl-horizontal">
          <dt>Severity</dt>
          <dd><tt><?php echo $details['severity']; ?></tt></dd>
        </dl>
        <dl class="dl-horizontal">
          <dt>Format line</dt>
          <dd><tt><?php echo nl2br($details['formatline']); ?></tt></dd>
        </dl>
      </p>
    </div>
</div>
